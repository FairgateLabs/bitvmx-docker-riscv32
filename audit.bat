...
call docker-run.bat riscv32 riscv32/build.sh src/audit/audit_12.c --output audit --with-mul
call docker-run.bat riscv32 riscv32/build.sh src/audit/audit_13.c --output audit --with-mul
